...
DEMO_PRESETS = {
    "rgbd_vo": {
        ...
        "override_config": "configs/benchmarks/tum_fr1_xyz_vo_flagship.yaml",
        "max_frames": 60,
        "video_path": "demo/videos/atlas_rgbd_vo_flagship.mp4",
        "gif_path": "demo/gifs/atlas_rgbd_vo_flagship.gif",
        "gif_fps": 8.0,
        "gif_max_frames": 60,
        "gif_width": 1200,
    }
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", choices=sorted(DEMO_PRESETS), default="rgbd_vo", help="Named demo preset to run.")
